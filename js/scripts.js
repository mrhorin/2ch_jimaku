...
var JimakuView, initialize, onMoveJimaku,
...
initialize = function() {
  ...
  return jimakuSubject.addEventListener("mousedown", onMoveJimaku, true);
};

onMoveJimaku = function(event) {
...
JimakuView = (function(_super) {
  ...
  JimakuView.prototype.create = function() {
    ...
    html.width = this.jimaku.width;
    html.height = this.jimaku.height;
    this.jimaku.alwaysInFront = true;
    this.jimaku.stage.addChild(html);
