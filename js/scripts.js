...
$(function() {
  ...
  $("#get-bbs").click(function() {
    ...
    bbsDbView.printBbs();
    return $(".bbs").click((function(_this) {
      return function() {
...
BbsDbView = (function(_super) {
  ...
  BbsDbView.prototype.printBbs = function() {
    var bbs;
    this.sectionToEmpty();
    bbs = this.bbsDb.bbsList;
    $.each(bbs, (function(_this) {
      return function(index, value) {
        var id;
        $("section").append($("<div class=\"bbs\" id=\"" + bbs[index]["id"] + "\">" + bbs[index]["name"] + "</div>").click(function() {
        ...
        return id.addEventListener("contextmenu", _this.showContextMenu(bbs[index]["id"]));
      };
    })(this));
  ...
  BbsDbView.prototype.showContextMenu = function(id) {
    return (function(_this) {
      return function(event) {
        ...
        deleteBbs.addEventListener(window.air.Event.SELECT, _this.deleteBbs);
        return contextMenu.display(window.nativeWindow.stage, event.clientX, event.clientY);
      };
    })(this);
  };

  BbsDbView.prototype.deleteBbs = function() {
    return alert("aaa");
  };
