...
window.BbsDb = (function() {
  ...
  BbsDb.prototype.selectBbs = function() {
    ...
    try {
      ...
      return this.air.trace("SELECT statement succeeded");
    } catch (_error) {
      error = _error;
      this.air.trace("Error message:", error.message);
      return this.air.trace("Details:", error.details);
...
BbsDbView = (function(_super) {
  ...
  BbsDbView.prototype.printBbs = function() {
    this.sectionToEmpty();
    $.each(this.bbsDb.bbsList, (function(_this) {
      return function(index, value) {
        return $("section").append($("<div class=\"bbs\">" + _this.bbsDb.bbsList[index]["name"] + "</div>").click(function() {
          return _this.clickedBbs = {
            "name": _this.bbsDb.bbsList[index]["name"],
            "url": _this.bbsDb.bbsList[index]["url"]
          };
        }));
      };
    })(this));
